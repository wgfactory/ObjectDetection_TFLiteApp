...
public final class Logger {
  private static final String DEFAULT_TAG = "ObjectApp";
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(com.wgf.objectapp_tflite.env.Logger.class.getCanonicalName());
  }
  ...
  private static String getCallerSimpleName() {
    ...
    return com.wgf.objectapp_tflite.env.Logger.class.getSimpleName();
  }
