...
package com.wgf.objectapp_tflite.env;
...
public class Size implements Comparable<Size>, Serializable {
   ...
   * @return Rotated size.
   */
  public static com.wgf.objectapp_tflite.env.Size getRotatedSize(final com.wgf.objectapp_tflite.env.Size size, final int rotation) {
    if (rotation % 180 != 0) {
      // The phone is portrait, therefore the camera is sideways and frame should be rotated.
      return new com.wgf.objectapp_tflite.env.Size(size.height, size.width);
    }
    return size;
  }

  public static com.wgf.objectapp_tflite.env.Size parseFromString(String sizeString) {
    ...
    if (components.length == 2) {
      try {
        ...
        return new com.wgf.objectapp_tflite.env.Size(width, height);
  ...
  public static List<Size> sizeStringToList(final String sizes) {
    ...
    if (sizes != null) {
      ...
      for (final String pair : pairs) {
        final com.wgf.objectapp_tflite.env.Size size = com.wgf.objectapp_tflite.env.Size.parseFromString(pair);
        if (size != null) {
          sizeList.add(size);
        }
      }
  ...
  @Override
  public int compareTo(final com.wgf.objectapp_tflite.env.Size other) {
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof com.wgf.objectapp_tflite.env.Size)) {
      return false;
    }

    final com.wgf.objectapp_tflite.env.Size otherSize = (com.wgf.objectapp_tflite.env.Size) other;
